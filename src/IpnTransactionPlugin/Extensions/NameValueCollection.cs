...
namespace IpnTransactionPlugin.Extensions
{
    ...
    public static class NameValueCollectionExtensions {
        ...
        /// <summary>
        /// Get the parsed value for the given key, and remove it from the collection if it exists.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="key"></param>
        /// <returns></returns>
        public static T? Pluck<T>(this NameValueCollection q, string key) where T : struct, IConvertible
        {
            return Pluck<T>(q,key, null);
        }
        /// <summary>
        /// Get the parsed value for the given key, and remove it from the collection if it exists.
        /// </summary>
        ...
        /// <param name="defaultValue"></param>
        /// <returns></returns>
        public static T? Pluck<T>(this NameValueCollection q, string key, T? defaultValue) where T : struct, IConvertible
        {
            var val = q.Get<T>(key, defaultValue);
            q.Remove(key);
            return val;
        }
        /// <summary>
        /// Gets the value for the given key, removing it from the collection if it is present.
        /// </summary>
        /// <param name="q"></param>
        /// <param name="key"></param>
        /// <returns></returns>
        public static  string Pluck(this NameValueCollection q, string key) { return Pluck(q, key, null); }
        /// <summary>
        /// Gets the value for the given key, removing it from the collection if it is present.
        /// </summary>
        /// <param name="q"></param>
        ...
        /// <param name="defaultValue"></param>
        /// <returns></returns>
        public static string Pluck(this NameValueCollection q, string key, string defaultValue)
        {
            var val = q.Get(key);
