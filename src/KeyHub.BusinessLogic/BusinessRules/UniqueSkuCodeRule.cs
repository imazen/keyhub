...
{
    public class UniqueSkuCodeRule : BusinessRule<SKU, DataContext>
    {
        /// <summary>
        ...
        protected override IEnumerable<BusinessRuleValidationResult> ExecuteValidation(SKU entity, DataContext context, DbEntityEntry entityEntry)
        {
