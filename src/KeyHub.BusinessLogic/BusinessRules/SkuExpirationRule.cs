...
namespace KeyHub.BusinessLogic.BusinessRules
{
    ...
    public class SkuExpirationRule : BusinessRule<TransactionItem, DataContext>
    {
        /// <summary>
        ...
        protected override IEnumerable<BusinessRuleValidationResult> ExecuteValidation(TransactionItem entity, DataContext context, DbEntityEntry entityEntry)
        {
