...
namespace KeyHub.Data.BusinessRules
{
    ...
    /// <typeparam name="TContext">The context type the entity belongs to</typeparam>
         ...
         where TContext : IDataContext
    {
        ...
        IEnumerable<BusinessRuleValidationResult> Validate(TEntity entity, TContext context, DbEntityEntry entityEntry);
    }   
}
