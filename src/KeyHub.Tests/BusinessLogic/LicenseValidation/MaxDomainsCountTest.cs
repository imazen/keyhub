...
//            var test = LicenseValidator.ValidateLicense(factory, null, new Guid(), null);
...
//            domainValidationResults = LicenseValidator.ValidateLicense(dataContextFactory, null, appKey, domainValidations).ToList();
